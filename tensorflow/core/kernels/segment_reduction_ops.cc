...
#define REGISTER_REAL_DML_UNSORTED_KERNELS_ALL(type) \
  REGISTER_REAL_DML_UNSORTED_KERNELS(type, int32);   \
  REGISTER_REAL_DML_UNSORTED_KERNELS(type, int64);

#define REGISTER_SUM_DML_UNSORTED_KERNELS_ALL(type) \
  REGISTER_SUM_DML_UNSORTED_KERNELS(type, int32);   \
  REGISTER_SUM_DML_UNSORTED_KERNELS(type, int64);
...
#undef REGISTER_DML_KERNEL_UNSORTEDSEGMENT
#undef REGISTER_REAL_DML_UNSORTED_KERNELS
#undef REGISTER_SUM_DML_UNSORTED_KERNELS
#undef REGISTER_REAL_DML_UNSORTED_KERNELS_ALL
#undef REGISTER_SUM_DML_UNSORTED_KERNELS_ALL
